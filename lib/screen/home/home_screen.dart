// ignore_for_file: prefer_const_constructors, avoid_unnecessary_containers, sort_child_properties_last, duplicate_ignore, sized_box_for_whitespace, unused_local_variable, unused_import, use_key_in_widget_constructors, must_be_immutable
            ...
            Container(
                ...
                child: ListView(
                        ...
                        Container(
                          ...
                          child: ListTile(
                            title: Text("A summer surprise",
                                style: TextStyle(
                                    color: AppColor.kTextColor, fontSize: 20)),
                            subtitle: Text("Cashback 20%",
                                style: TextStyle(
                                    color: AppColor.kTextColor, fontSize: 30)),
                          ),
                          height: 150,
                 ...
                 SizedBox(
                  ...
                  child: ListItemsSearch(listdatamodel: homeController.listdata)
